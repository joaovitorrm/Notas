...
export default function TopBar({onMinimize, onMouseDown, onDelete} : TopBarProps) {
    return (
        <div className={styles["top-bar"]} onMouseDown={(e) => onMouseDown(e)}>

            <span className={styles["minimize-icon"]} onMouseDown={() => onMinimize()}>—</span>

            {/* <svg id="arrow-circle-down" viewBox="0 0 24 24" width="16" height="16" className={styles["move-icon"]} >
            ...
            <svg version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 512 512" width="16" height="16" className={styles["delete-icon"]} onMouseDown={((e) => e.stopPropagation())} onMouseUp={(e) => {e.stopPropagation(); onDelete()}}>
                <g>
